...
public class DualStrusionWindow extends JFrame{
	...
	private JPanel createSelectionPanel()
	{
		...
		JButton leftChooserButton = new JButton("ä¯ÀÀ...");
		...
		panel.add(new JLabel("×óÅçÍ·"), "split");
		...
		JButton rightChooserButton = new JButton("ä¯ÀÀ...");
...
//		panel.add(switchItem, "wrap");
		panel.add(new JLabel("ÓÒÅçÍ·"), "split");
		...
		JButton destinationChooserButton = new JButton("ä¯ÀÀ...");
		...
		panel.add(new JLabel("±£´æÎª: "), "split");
...
//		panel.add(useWipes, "wrap");
		...
		//Merge
		JButton merge = new JButton("ºÏ³É");
...
//				uWipe = useWipes.isSelected();
		...
		final JButton help = new JButton("°ïÖú");
		help.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				try {
					Desktop.getDesktop().browse(new URI("http://www.sz3dp.com/°ïÖú-help/creatorÏµÁÐ/Ë«Í·´òÓ¡/"));
